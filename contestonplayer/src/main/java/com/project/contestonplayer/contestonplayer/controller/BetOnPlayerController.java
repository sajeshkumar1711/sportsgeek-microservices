package com.project.contestonplayer.contestonplayer.controller;

import com.project.contestonplayer.contestonplayer.exception.ContestOnPlayerException;
import com.project.contestonplayer.contestonplayer.model.BetOnPlayer;
import com.project.contestonplayer.contestonplayer.model.BetOnPlayerResponse;
import com.project.contestonplayer.contestonplayer.service.BetOnPlayerService;
...
public class BetOnPlayerController {
    ...
    @ApiResponses(value =
            {
                    @ApiResponse(code = 200, message = "success", response = BetOnPlayerResponse.class),
    ...
    @ApiResponses(value =
            {
                    @ApiResponse(code = 201, message = "success", response = BetOnPlayerResponse.class),
                    @ApiResponse(code = 400, message = "Bad request", response = ContestOnPlayerException.class),
                    @ApiResponse(code = 500, message = "Unfortunately there is technical error while processing your request", response = ContestOnPlayerException.class),
                    @ApiResponse(code = 403 , message = "Forbidden!! Access is Denied!")
            }
