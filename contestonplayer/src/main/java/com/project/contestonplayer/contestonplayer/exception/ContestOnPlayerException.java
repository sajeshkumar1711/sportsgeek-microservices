package com.project.contestonplayer.contestonplayer.exception;
...
@ControllerAdvice
public class ContestOnPlayerException extends ResponseEntityExceptionHandler {
    private static Logger logger = LoggerFactory.getLogger(ContestOnPlayerException.class);
