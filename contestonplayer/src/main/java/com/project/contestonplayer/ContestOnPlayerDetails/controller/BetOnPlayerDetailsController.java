package com.project.contestonplayer.ContestOnPlayerDetails.controller;


import com.project.contestonplayer.ContestOnPlayerDetails.exception.ContestOnPlayerDetailsException;
...
import com.project.contestonplayer.ContestOnPlayerDetails.service.BetOnPlayerDetailsService;
...
public class BetOnPlayerDetailsController {
    ...
    @ApiResponses(value =
            {
                    @ApiResponse(code = 200, message = "success", response = BetPlayerDetailsResponse.class),
    ...
    @ApiResponses(value =
            {
                    @ApiResponse(code = 201, message = "success", response = BetPlayerDetailsResponse.class),
