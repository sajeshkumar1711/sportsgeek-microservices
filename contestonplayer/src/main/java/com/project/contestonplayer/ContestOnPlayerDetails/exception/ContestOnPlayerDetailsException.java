package com.project.contestonplayer.ContestOnPlayerDetails.exception;
...
@ControllerAdvice
public class ContestOnPlayerDetailsException extends ResponseEntityExceptionHandler {
    private static Logger logger = LoggerFactory.getLogger(ContestOnPlayerDetailsException.class);
