package com.project.players.player.exception;
...
@ControllerAdvice
public class PlayerException extends ResponseEntityExceptionHandler {
    private static Logger logger = LoggerFactory.getLogger(com.project.players.playertype.exception.PlayerTypeException.class);
