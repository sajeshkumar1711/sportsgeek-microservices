package com.project.players.player.controller;

import com.project.players.player.exception.PlayerException;
import com.project.players.player.model.Player;
import com.project.players.player.model.PlayerResponse;
import com.project.players.player.service.PlayerService;
...
public class PlayerController {
    ...
    @ApiResponses(value =
            {
                    @ApiResponse(code = 200, message = "success", response = PlayerResponse.class),
