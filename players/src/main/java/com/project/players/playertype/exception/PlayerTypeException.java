package com.project.players.playertype.exception;
...
@ControllerAdvice
public class PlayerTypeException extends ResponseEntityExceptionHandler {
    private static Logger logger = LoggerFactory.getLogger(PlayerTypeException.class);
