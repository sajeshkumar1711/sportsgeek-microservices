package com.project.utilities.venue.exception;
...
@ControllerAdvice
public class VenueException extends ResponseEntityExceptionHandler {
    private static Logger logger = LoggerFactory.getLogger(VenueException.class);
