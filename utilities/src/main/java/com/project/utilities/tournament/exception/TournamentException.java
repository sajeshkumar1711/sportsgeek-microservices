package com.project.utilities.tournament.exception;
...
import com.project.utilities.team.exception.TeamException;
...
@ControllerAdvice
public class TournamentException extends ResponseEntityExceptionHandler {
    private static Logger logger = LoggerFactory.getLogger(TournamentException.class);
