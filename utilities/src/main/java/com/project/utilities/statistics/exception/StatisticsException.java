package com.project.utilities.statistics.exception;
...
@ControllerAdvice
public class StatisticsException extends ResponseEntityExceptionHandler {
    private static Logger logger = LoggerFactory.getLogger(StatisticsException.class);
