package com.project.matches.matches.exception;
...
@ControllerAdvice
public class MatchesException extends ResponseEntityExceptionHandler {
    private static Logger logger = LoggerFactory.getLogger(MatchesException.class);
