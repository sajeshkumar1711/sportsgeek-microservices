package com.project.matches.matches.controller;

import com.project.matches.matches.exception.MatchesException;
import com.project.matches.matches.model.Matches;
import com.project.matches.matches.model.MatchesWithVenue;
import com.project.matches.matches.service.MatchesService;
...
public class MatchesController {
    ...
    @ApiResponses(value =
            {
                    @ApiResponse(code = 200, message = "success", response = MatchesWithVenue.class),
