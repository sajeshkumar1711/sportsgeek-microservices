...
import com.project.matches.mymatches.mapper.MyMatchesResultRowMapper;
import com.project.matches.mymatches.mapper.MyMatchesRowMapper;
...
public class MyMatchesRepoImpl implements MyMatchesRepository {
    ...
    public List<MyMatches> findUpcomingContestByUserId(int userId) throws Exception {
       String sql = " SELECT StartDatetime, t3.ShortName as TeamName, BetPoints,bot.MatchId as MatchId, t1.ShortName as Team1Short, t1.TeamLogo as Team1Logo, t2.ShortName as Team2Short, t2.TeamLogo as Team2Logo, v.Name as Venue\n" +
             ...
             return jdbcTemplate.query(sql,new MyMatchesRowMapper());
    }
...
//        String sql = " SELECT StartDatetime, t3.ShortName as TeamName, BetPoints, t1.ShortName as Team1Short, t1.TeamLogo as Team1Logo, t2.ShortName as Team2Short, t2.TeamLogo as Team2Logo, v.Name as Venue\n" +
//                "        FROM Matches as m inner join Team as t1 on m.Team1=t1.TeamId\n" +
//                "        inner join Team as t2 on m.Team2=t2.TeamId\n" +
//                "        inner join BetOnTeam as bot on bot.MatchId = m.MatchId\n" +
//                "        inner join Team as t3 on bot.TeamId = t3.TeamId\n" +
//                "        inner join Venue as v on m.VenueId = v.VenueId WHERE m.StartDateTime < CURRENT_TIMESTAMP and ResultStatus IS NOT NULL and bot.UserId="+userId+" order by StartDatetime";
