package com.project.matches.mymatches.exception;
...
@ControllerAdvice
public class MyMatchesException extends ResponseEntityExceptionHandler {
    private static Logger logger = LoggerFactory.getLogger(MyMatchesException.class);
